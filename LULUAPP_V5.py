...
class MaterialsTestingHub:
    def __init__(self):
        ...
        # First radar chart data
        self.importance_levels = self.get_importance_levels(self.add_temperature, self.add_humidity, self.add_exercise)
        self.importance_levels_2 = self.get_importance_levels(self.add_temperature_2, self.add_humidity_2, self.add_exercise_2)
    ...
    def get_importance_levels(self, temperature, humidity, exercise):
        lookup = {
            ...
            ("> 25°C", "40% RH", "High"): {"Insulation": 1, "Breathability": 5, "Moisture Management": 5, "Thermal Hand": 3, "Density": 2},
...
def main():
    # Set up the page config once
    st.set_page_config(
        page_title="Materials Testing Hub", 
        page_icon=":scissors:", 
        layout="wide",
        menu_items={'About': "This is created to guide you through materials testing"}
    )
