...
class MaterialsTestingHub:
    ...
    def display_radar_charts(self):
        st.markdown("### Radar Charts of Materials Properties")
        ...
        with col1:
            ...
            **How to interpret the radar chart:**
            - These radar charts represent the importance levels for each materials property for each set of selected conditions.
            - Each axis corresponds to a specific materials property (e.g., Insulation, Breathability, etc.).
            - Higher number for each property, correlates to a higher value for this certain property (e.g., 5 on breathability axis indicates highest breathability value possible).
            """)
        with col2:
    ...
    def display_popovers(self):
        ...
        with st.expander("Insulation"):
            if st.checkbox("Thermal Insulation (Resistance)"):
                ...
                st.markdown("**Time to Complete the Test** : 45 - 60 minutes Per Specimen")
            ...
            if st.checkbox("Alternative Method - Modified Transient Plane Source (MTPS)"):
                ...
                st.markdown("**Time to Complete the Test** : 5 - 10 minutes Per Specimen")
        ...
        with st.expander("Breathability"):
            if st.checkbox("Evaporative Resistance"):
                ...
                st.markdown("**Sample Size**: 30cm X 30cm")
                st.markdown("**Recommended Number of Specimens**: 3")
                st.markdown("**Time to Complete the Test** : 60 - 90 minutes Per Specimen")
                with open("ASTM_F1868_Standard.pdf", "rb") as pdf_file:
                    st.download_button(
                        label="Download ASTM F1868 Standard (PDF)",
                        data=pdf_file,
            ...
            if st.checkbox("Water Vapor Transmission Rate"):
                ...
                st.markdown("**Recommended Number of Specimens**: 3")
                st.markdown("**Time to Complete the Test** : 24 Hours Per Specimen")
        ...
        with st.expander("Moisture Management"):
            if st.checkbox("Horizontal Wicking"):
                ...
                st.markdown("**Recommended Number of Specimens**: 3")
                st.markdown("**Time to Complete the Test** : 15 - 30 minutes Per Specimen")
            if st.checkbox("Vertical Wicking"):
                ...
                st.markdown("**Recommended Number of Specimens**: 3")
                st.markdown("**Time to Complete the Test** : 30 - 45 minutes Per Specimen")
            ...
            if st.checkbox("Water Absorption"):
                ...
                st.markdown("**Recommended Number of Specimens**: 3")
                st.markdown("**Time to Complete the Test** : 30 - 60 minutes Per Specimen")
...
def main():
    ...
    # Define tabs
    tabs = st.tabs(["Materials Testing Hub", "Other Features"])
